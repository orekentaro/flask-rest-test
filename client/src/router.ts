...
const routes = [
  {
    ...
    children: [
      ...
      {
        path: "/job_vacancies_list",
        name: "jobVacanciesrList",
        component: JobVacanciesList,
      },
      { path: "/dashboard", name: "dashBoard", component: DashBoard },
      { path: "/recruiter", name: "recruiter", component: Recruiter },
      {
        path: "/recruitement_flow",
        name: "recruitementFlow",
        component: RecruitementFlow,
      },
      { path: "/permisson", name: "permission", component: Permission },
      {
        path: "/parameter_stor",
        name: "parameterStor",
        component: ParameterStor,
      },
    ],
  },
...
router.beforeEach((to, from, next) => {
  store.dispatch("update", Cookies.get("csrf_access_token"));
  if (to.name != "login") {
